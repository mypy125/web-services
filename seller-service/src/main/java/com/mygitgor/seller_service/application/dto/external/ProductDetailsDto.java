...
@Builder
@Schema(description = "Product details DTO represented as an immutable record")
public record ProductDetailsDto(
        ...
        @Schema(description = "Video URL", example = "https://example.com/product.mp4")
        String videoUrl,
        ...
        @Schema(description = "Warranty", example = "1 year warranty")
        String warranty
) {}