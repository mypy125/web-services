...
@Builder
@Schema(description = "Event emitted when a seller is suspended")
public record SellerSuspendedEvent(
        ...
        @Schema(description = "Reason", example = "Violation of terms")
        String reason,

        @Schema(description = "Suspended by", example = "admin@example.com")
        String suspendedBy,

        @Schema(description = "Suspended at")
