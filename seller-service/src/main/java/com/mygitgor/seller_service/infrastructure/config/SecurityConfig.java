...
import com.mygitgor.seller_service.infrastructure.sequrity.JwtAuthenticationConverter;
...
public class SecurityConfig {
    ...
    public SecurityWebFilterChain internalSecurityWebFilterChain(ServerHttpSecurity http) {
        log.debug("Configuring Internal API Security for SellerService (service-to-service)");
    ...
    public SecurityWebFilterChain publicSecurityWebFilterChain(ServerHttpSecurity http) {
        log.debug("Configuring Public API Security for SellerService");
        ...
        return http
                ...
                .authorizeExchange(exchange -> exchange
                        ...
                        .pathMatchers("/api/v1/sellers/{sellerId}/addresses/**").hasAnyRole("SELLER", "ADMIN")
                        .pathMatchers("/api/v1/sellers/**").hasAnyRole("SELLER", "ADMIN")
