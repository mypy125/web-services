...
public interface OrderStatsMapper {
    ...
    OrderStats toOrderStats(Transaction transaction);

    @Mapping(target = "status", source = "transaction.status", qualifiedByName = "statusToString")
    @Mapping(target = "customerId", source = "transaction.customerId", qualifiedByName = "customerIdToString")
    ...
    OrderStats toOrderStatsWithProduct(Transaction transaction, ProductDetailsDto product);
    ...
    @Mapping(target = "discount", source = "transaction.discount", qualifiedByName = "nullToZero")
    @Mapping(target = "commission", source = "transaction.commission", qualifiedByName = "nullToZero")
    OrderStats toOrderStatsFull(Transaction transaction, OrderDetailsDto order, ProductDetailsDto product);
    ...
    default String customerIdToString(UserId userId) {
        if (userId == null) {
            return null;
        }
    ...
    @Named("nullToZeroInt")
    default Integer nullToZeroInt(Integer value) {
