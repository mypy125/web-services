...
@Schema(description = "Data transfer object representing a request to notify a user about their account status change")
public record AccountStatusChangeRequest(
        ...
        @Schema(description = "The newly applied account status", example = "ACTIVATED")
